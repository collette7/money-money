...
const DEFAULT_PATTERNS: { category: string; patterns: string[]; amountHint?: AmountHint }[] = [
  ...
  { category: "Nightlife", amountHint: "negative", patterns: ["bar ", "pub ", "brewery", "taproom", "wine bar", "cocktail", "lounge", "nightclub", "club ", "speakeasy", "ticketmaster", "stubhub", "fandango", "amc", "alamo drafthouse", "live nation", "livenation", "bowlero", "topgolf", "dave and buster", "dave & buster", "karaoke", "comedy club", "improv"] },
