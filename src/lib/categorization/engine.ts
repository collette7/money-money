...
const DEFAULT_PATTERNS: { category: string; patterns: string[]; amountHint?: AmountHint }[] = [
  ...
  { category: "Dining Out & Delivery", amountHint: "negative", patterns: ["mcdonald", "starbucks", "chipotle", "domino", "pizza", "burger", "subway", "dunkin", "panera", "chick-fil", "taco bell", "wendy", "grubhub", "doordash", "uber eat", "postmates", "opentable", "resy", "tock", "denny", "ihop", "applebee", "chili", "olive garden", "outback", "cheesecake factory", "panda express", "popeye", "five guys", "shake shack", "wingstop", "buffalo wild", "noodles", "pho", "sushi", "ramen", "thai", "chinese", "indian", "korean bbq", "waffle house"] },
  { category: "Entertainment & Nightlife", amountHint: "negative", patterns: ["bar ", "pub ", "brewery", "taproom", "wine bar", "cocktail", "lounge", "nightclub", "club ", "speakeasy", "ticketmaster", "stubhub", "fandango", "amc", "alamo drafthouse", "live nation", "livenation", "bowlero", "topgolf", "dave and buster", "dave & buster", "karaoke", "comedy club", "improv"] },
